...
class PlayerManager {
    ...
    public function add(Player $pl) {
        $q = $this->_bdd->prepare('INSERT INTO elo_teams_players SET idTeam = :idTeam, idSummoner = :idSummoner, name = :name, league = :league, division = :division, avatar = :avatar');
        ...
        $q->execute();
        debug("Player '" . $pl->getName() . "' added to the database.");
    }
